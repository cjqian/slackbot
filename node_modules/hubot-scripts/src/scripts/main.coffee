...
module.exports = (robot) ->
    ...
    comments = [
        ...
        "Coding? Lame. You guys are nerds.",
    ...
    replies = [
        ...
        "Girls with [butts] like mine do not talk to boys with faces like yours. -Mean Girls",
    ...
    robot.hear /tfi|princeton/i, (res) ->
    ...
    #
    #
    enterReplies = ['Sup, fellow human?', 'Hello, world!', 'Hi!', 'Hi, homies.']
