...
module.exports = (robot) ->
    ...
    giphies = [
        "Oh man, I love giphies!",
        "That was a NSFW giphy.",
        "Tastesless. Smh.",
    ]
    omgs = [
        "OMG is right",
    ...
    robot.hear /jvd/i, (res) ->        
        r = Math.random()
        if(get_channel(res) != channel_to_watch and r > p and !recentlyCalled)
    ...
    robot.hear /think|guess/i, (res) ->
        opinions = [
            ...
            "I laughed, " + get_username(res) + ", that was such a ridiculous thought.",
        ]
